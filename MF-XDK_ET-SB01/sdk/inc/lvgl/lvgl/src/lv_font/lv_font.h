...
int lv_add_font(char* fontname, lv_font_t* font);
/**********************
 * GLOBAL PROTOTYPES
 **********************/
...
LV_FONT_DECLARE(font_mf_12);
LV_FONT_DECLARE(font_mf_16);
LV_FONT_DECLARE(font_mf_24);
LV_FONT_DECLARE(font_mf_32);
LV_FONT_DECLARE(font_mf_hz1);
LV_FONT_DECLARE(font_mf_hz2);

int lv_set_nomal_font(char* fontname);
lv_font_t* lv_get_font(char* name);

LV_FONT_DECLARE(lv_font_hz16)
