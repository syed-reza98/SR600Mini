...
#define LV_HOR_320_RES_MAX      (320)
#define LV_VER_480_RES_MAX      (480)


#define LV_HOR_128_RES_MAX      (128)
#define LV_VER_32_RES_MAX      (32)
...
#define LV_DISP_DEF_REFR_PERIOD      30//16      /*[ms]*/
...
#  define LV_MEM_CUSTOM_ALLOC   osl_malloc       /*Wrapper to malloc*/
#  define LV_MEM_CUSTOM_FREE    osl_free         /*Wrapper to free*/
#endif     /*LV_MEM_CUSTOM*/
...
#define LV_INDEV_DEF_DRAG_THROW         100  //20(1-100)
...
#define LV_INDEV_DEF_GESTURE_MIN_VELOCITY 4
...
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (osl_GetTick())
#endif
...
#define LV_FONT_SIMFANG_16            1 /*  simfang */
...
#if LV_USE_TILEVIEW
/*Time of slide animation [ms] (0: no animation)*/
#  define LV_TILEVIEW_DEF_ANIM_TIME   50
#endif
