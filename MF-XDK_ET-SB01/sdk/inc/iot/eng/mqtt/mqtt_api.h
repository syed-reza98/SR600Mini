 ...
 * @see None.
 */
LIB_EXPORT void *IOT_MQTT_Construct(iotx_mqtt_param_t *pInitParams);
 ...
 * @see None.
 */
LIB_EXPORT int IOT_MQTT_Destroy(void **phandle);
 ...
 * @see None.
 */
LIB_EXPORT int IOT_MQTT_Yield(void *handle, int timeout_ms);
 ...
 * @see None.
 */
LIB_EXPORT int IOT_MQTT_CheckStateNormal(void *handle);
 ...
 * @see None.
 */
LIB_EXPORT int IOT_MQTT_Subscribe(void *handle,
 ...
 * @see None.
 */
LIB_EXPORT int IOT_MQTT_Subscribe_Sync(void *handle,
                            const char *topic_filter,
                            iotx_mqtt_qos_t qos,
                            iotx_mqtt_event_handle_func_fpt topic_handle_func,
                            void *pcontext,
 ...
 * @see None.
 */
LIB_EXPORT int IOT_MQTT_Unsubscribe(void *handle, const char *topic_filter);
 ...
 * @see None.
 */
LIB_EXPORT int IOT_MQTT_Publish(void *handle, const char *topic_name, iotx_mqtt_topic_info_pt topic_msg);
/**
 * @brief Publish message to specific topic.
 *
 * @param [in] handle: specify the MQTT client.
 ...
 * @see None.
 */
LIB_EXPORT int IOT_MQTT_Publish_Simple(void *handle, const char *topic_name, int qos, void *data, int len);
/* From mqtt_client.h */
/** @} */ /* end of api_mqtt */
 ...
 *
 */
LIB_EXPORT int IOT_MQTT_Nwk_Event_Handler(void *handle, iotx_mqtt_nwk_event_t event, iotx_mqtt_nwk_param_t *param);
LIB_EXPORT void IOT_MQTT_Start_Ping(void *handle);
LIB_EXPORT int IOT_MQTT_Keepalive_probes(void *handle);
/* MQTT Configurations
 *
