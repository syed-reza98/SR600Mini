 ...
 * Core Version label
 */
#define QL_CORE_VERSION "SR600MINI"

/**
 * Specify Project Main Name for Quectel
 */
#define CONFIG_QL_PROJECT_DEF_EC600U

/**
 * Specify Project Sub Name for Quectel
 */
#define CONFIG_QL_PROJECT_DEF_SUB_CE_AB

/**
 * Specify Project FULL Name for Quectel
 */
#define CONFIG_QL_PROJECT_DEF_EC600U_CE_AB

/**
 * Specify SDK BUILD Flag for Quectel
 */
#define CONFIG_QL_CCSDK_BUILD_ON

/**
 * Used to identify breaking changes to the UNISOC baseline
 */
#define CONFIG_QUEC_UNISOC_NEW_BASELINE
...
/**
 * whether to specify DMHTTP feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_DMHTTP */
...
/**
 * whether to specify SNMP feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_SNMP */
...
/**
 * whether to specify USB HID feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_USB_HID_DEVICE */
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_VOICE_CALL
...
/**
 * whether to specify BT HFP feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_BT_HFP */

/**
 * whether to specify BT HFP feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_BT_HFP_AG */

/**
 * whether to specify BT SPP feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_BT_SPP */

/**
 * whether to specify BT A2DP & AVRCP feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_BT_A2DP_AVRCP */

/**
 * whether to specify BT A2DP & AVRCP SRC feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_BT_A2DP_AVRCP_SRC */
...
/**
 * whether to specify BT_SDP feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_BT_SDP */

/**
 * whether to specify WIFISCAN feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_WIFISCAN */
 ...
 * whether to specify LCD feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_MIPI_LCD */
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_SPI6_NAND_FLASH
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_AUDIO

/**
 * whether to specify AUDIO aac feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_AUDIO_DEC_AAC */
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_USB_SUSPEND
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_BOOT_LCD
...
/**
 * whether to specify Boot SPI4 BUS feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_BOOT_SPI4_BUS */
 ...
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_BOOT_FAT_RDONLY */
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_EXT_CODEC
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_USB_AUDIO
 ...
 */
/* #undef CONFIG_SUPPORT_INNER_DELTA_NV */
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_JAMDET
 ...
 * whether to specify USB feature for Quectel
 */
#define CONFIG_QUEC_PROJECT_FEATURE_USB_DRIVERS
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_FS_NAND_FLASH
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_EMBED_NOR_FLASH
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_BOOT_ADC
 ...
 */
#define CONFIG_QUEC_PROJECT_FEATURE_DTMF
 ...
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_LCD_GC9305 */

/**
 * whether to specify LCD DRIVER feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_LCD_ST7735S */

/**
 * whether to specify LCD DRIVER feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_LCD_ST7789V */
 ...
 * whether to specify LCD DRIVER feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_LCD_ST7796S */

/**
 * whether to specify LCD DRIVER feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_LCD_ST7365P */

/**
 * whether to specify MIPI LCD DRIVER feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_MIPI_LCD_ST7701S */

/**
 * whether to specify MIPI LCD DRIVER feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_MIPI_LCD_JD9365DA */

/**
 * whether to specify MIPI LCD DRIVER feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_MIPI_LCD_SC7705 */

/**
 * whether to specify MIPI LCD DRIVER feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_MIPI_LCD_ST7365 */

/**
* PSRAM or DDR address for MIPI LCD dispaly
*/
#define CONFIG_QUEC_APP_MIPI_LCD_RAM_ADDRESS 0x80fa0000

/**
* PSRAM or DDR size for MIPI LCD dispaly
*/
#define CONFIG_QUEC_APP_MIPI_LCD_RAM_SIZE  0x0000
 ...
 * whether to specify CAMERA DRIVER feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_CAMERA_BF3095 */
...
/**
 * whether to specify SS feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_SS */
...
/**
 * whether to specify L2TP feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_L2TP */

/**
 * whether to specify OHOS feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_OHOS */

/**
 * whether to specify OHOS IOT feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_OHOS_IOT */

/**
 * whether to specify OHOS CMSIS feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_OHOS_CMSIS */

/**
 * whether to specify OHOS POSIX feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_OHOS_POSIX */

/**
 * whether to specify OHOS XTS feature for Quectel
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_OHOS_XTS */

/**
 * whether to specify QuecScan feature for Quectel
 */
#define CONFIG_QUEC_PROJECT_FEATURE_QUECSCAN

/**
 * whether to specify SLAS feature for Quectel
 */
#define CONFIG_QUEC_PROJECT_FEATURE_SLAS

/**
 * whether to specify XLAT feature for Quectel
 */
#define CONFIG_QUEC_PROJECT_FEATURE_XLAT
 
/**
 * whether to specify CNTKD API feature
 */
/* #undef CONFIG_QUEC_PROJECT_FEATURE_CNKTD */
