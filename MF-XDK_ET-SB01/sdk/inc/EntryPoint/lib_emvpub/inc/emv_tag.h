...
#define EMV_TAG_DF20_TM_RF_LIMIT					"\xDF\x20"	/**< 非接触终端交易限额*/
#define EMV_TAG_DF19_TM_RF_OFFLINELIMIT				"\xDF\x19"	/**< 非接触终端脱机交易限额*/
...
#define AMEX_TAG_DF8608_RF_AIDLIST					 "\xDF\x86\x08"		//amex aid列表指示器
...
#define DPAS_FF8109_CVM_RET					"\xDF\x81\x09"		//使用自己的工具用DF8109
...
#define DEF_TAG_EXEC_CTL_2TAP_SIGN	"\xDF\x84\x06"		//非接2TAP标志      0--未执行  1--已执行
#define DEF_TAG_DF8406_PIN_BYPASS	"\xDF\x84\x07"		//PIN bypass 标识	0-默认值  1-本次交易支持bypass
